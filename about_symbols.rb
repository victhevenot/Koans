...
class AboutSymbols < EdgeCase::Koan
  ...
  # Answer: symbols are unique, the oposite way will create the symbol that I want to find, so always will be true
  ...
  #Answer: = each string concat create a new string, that need to be parsed to a symbol
end
